        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center py-3 px-6 md:px-12">
          ...
          <nav className="hidden md:flex items-center gap-6 text-base font-medium flex-wrap">
            ...
            <div className="relative flex items-center justify-center">
              <Search
                placeholder="e.g single,shared,name etc"
                value={searchTerm}
                onChange={handleSearchInputChange}
                onSearch={handleSeach}
                onPressEnter={handleKeyPress}
                enterButton
                className={`${open ? "" : "md:hidden"} text-sm`} // Add "text-sm" for smaller font size
                style={{ fontSize: "9px" }} // Alternatively, use inline styles for precise control
              />
            </div>
            <button
              onClick={goToSingIn}
            ...
            <Button onClick={goToSignUp} title="Sign up" />
            <ProfileButton />
          </nav>
