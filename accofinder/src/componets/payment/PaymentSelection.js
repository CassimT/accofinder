...
function PaymentSelection(){
  ...
  return (
    <div className="w-full h-screen">
      <div className="flex flex-col h-[60vh] items-center justify-center relative bg-[url('./components/assets/pay3.jpg')] bg-cover bg-no-repeat">
        ...
        <p className="m-3">OR</p>
         <button className="hover:scale-95 w-[70%] transition duration-500 px-10 py-2 border-2 bg-indigo-200 border-indigo-400 rounded-lg font-sans font-semibold">
            Mobile /Airtelmoney
          </button>
        </div>
      </div>
